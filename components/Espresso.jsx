...
const Image = styled.div`
  ...
  border-radius: 1rem;
  background-image: url(${"https://images.unsplash.com/photo-1634568574054-0ab278fdc1e9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2780&q=80"});
`;
...
export default function Pop({ height = 400, width = 300 }) {
  const ref = useRef();
